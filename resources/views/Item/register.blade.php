...
<div class="container">
 ...
 <div class="col-md-8">
 <div class="card">
 <div class="card-header">{{ __('PLEACE REGISTER YOUR Item') }}</div>
 <div class="card-body">
...
name" autofocus>
 ...
 <div class="form-group row">
 <label for="model" class="col-md-4 col-formlabel text-md-right">{{ __('model') }}</label>
 <div class="col-md-6">
 <input id="model" type="text" class="formcontrol @error('model') isinvalid @enderror" name="model" value="{{ old('model') }}" required autocomplete
="model">
 @error('model')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
